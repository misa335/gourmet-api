  ...
  return knex('visited').del()
    .then(function () {
      ...
      return knex('visited').insert([
        {image: 'https://lh5.googleusercontent.com/p/AF1QipNqARM3BeJbVX4X-DGZ11QYOReR3GLMU3K7g-0q=w408-h306-k-no', name: 'Cinnabon', menu: 'Classic Cinnamon Roll', genre: 'カフェ・スイーツ', date: '2020-06-25', rate: 5.0, comment: 'I loooove Cinnabon!', lat: 35.66,lng: 139.73},
